      ...
      gap-20 my-10'>
        ...
        <div className='flex-1'>
          <p className='mb-10 max-w-2xl font-Ovo'>
            As a full-stack developer, I'm committed to building high-quality
            software and contributing my skills to the ever-evolving tech industry,
            and I'm a final-year Bachelor of Information Technology student at the 
          ...
          max-w-2xl'>
            {infoList.map(({icon, iconDark, title, description}, 
              index)=>(
                <li className={`border-[0.5px] 
                rounded-xl p-6 cursor-pointer 
                 hover:-translate-y-1 duration-500 shadow
                  ${isDarkMode ? 'border-white hover:shadow-white hover:bg-[#2a004a]/50' :'border-gray-400 hover:shadow-black hover:bg-[#fcf4ff]'}   
                `}
                key={index}>
